...
function getMonitorDashboardConfig(modelName, firmwareVersion) {
  ...
  return Object.keys(groups).length > 0 ? { groups, sectionLayout, queryMapping: readMonitorQueryMapping(monitor) } : null;
}
...
function ParamSectionCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card dashboard-param-matrix-cell", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dashboard-param-section-cols", children: columnChunks.map((colEntries, colIndex) => /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "dashboard-param-list dashboard-param-col", children: colEntries.map(([name, spec]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "dashboard-param-row", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dashboard-param-default", children: liveByParamName?.[name] ?? formatDefault(spec.length > 1 ? spec[1] : void 0) }),
...
function parseMonitorSerialSnapshots(serialLines) {
  let pending = null;
...
function valueFromSpec(spec, words, coils) {
  ...
  let raw = words[ri] & 65535;
  if (mode === "int16") raw = raw << 16 >> 16;
  return formatScaledNumber(raw * mult);
}
function buildMonitorLiveValueMap(config, snap) {
  const out = {};
  const { groups, queryMapping } = config;
  for (const groupKey of Object.keys(groups)) {
    ...
    for (const [paramName, spec] of Object.entries(block)) {
      ...
      const v = valueFromSpec(spec, words, coils);
      if (v !== null) out[paramName] = v;
    }
  }
  return out;
}
function computeMonitorLiveValues(serialLines, config) {
  ...
  return buildMonitorLiveValueMap(config, snap);
}
function Dashboard() {
