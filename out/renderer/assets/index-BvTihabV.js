...
function sectionGridFromMonitor(m) {
  const leftCols = positiveInt(m.left_labels_1_columns, 2);
  const leftRows = positiveInt(m.left_labels_1_custom_rows, 6);
  const rightCols = positiveInt(m.right_labels_1_columns, 2);
  const rightRows = positiveInt(m.right_labels_1_custom_rows, 8);
  return {
    cooling_params: {
      columns: positiveInt(m.cooling_params_columns, leftCols),
      rows: positiveInt(m.cooling_params_rows, leftRows)
    },
    power_params: {
      columns: positiveInt(m.power_params_columns, leftCols),
      rows: positiveInt(m.power_params_rows, leftRows)
    },
    alarm_params: {
      columns: positiveInt(m.alarm_params_columns, rightCols),
      rows: positiveInt(m.alarm_params_rows, rightRows)
    },
    version_params: {
      columns: positiveInt(m.version_params_columns, rightCols),
      rows: positiveInt(m.version_params_rows, rightRows)
    }
  };
}
function getMonitorDashboardConfig(modelName, firmwareVersion) {
  ...
  return {
    groups,
    sectionGrid: sectionGridFromMonitor(m)
  };
}
...
function ParamSectionCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card dashboard-param-matrix-cell", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "ul",
      {
        className: "dashboard-param-list dashboard-param-list--grid",
        style: {
          gridTemplateColumns: `repeat(${grid.columns}, minmax(0, 1fr))`,
          gridTemplateRows: `repeat(${grid.rows}, minmax(0, auto))`
        },
        children: Object.entries(block).map(([name, spec]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "dashboard-param-row", children: [
...
function Dashboard() {
  ...
  const groups = dashboardConfig?.groups;
  const sectionGrid = dashboardConfig?.sectionGrid;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "page-title", children: "Dashboard" }),
    !groups || !sectionGrid ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
...
function AppLayout() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-layout", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-main", children: [
      ...
      displayView === "data" && serialSession ? /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "serial-readout", "aria-label": "Serial connection", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "serial-readout-bar", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "serial-readout-dot", "aria-hidden": "true" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "serial-readout-summary", children: [
            "Port ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "serial-readout-log", role: "log", "aria-live": "polite", children: serialLines.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "serial-readout-placeholder", children: "Reading port — waiting for incoming bytes…" }) : serialLines.map((row) => {
          const tab = row.indexOf("	");
          const key = tab >= 0 ? row.slice(0, tab) : row;
          const text = tab >= 0 ? row.slice(tab + 1) : row;
