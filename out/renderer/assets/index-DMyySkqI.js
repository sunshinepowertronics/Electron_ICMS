...
function readSectionLayout(monitor, group) {
  ...
  const rows = clampInt(monitor[rowKey], 1, 40, DEFAULT_SECTION_LAYOUT.rows);
  return { columns, rows };
}
...
function ParamSectionCard({
  ...
  const listStyle = {
    ...
    maxHeight: `calc(${layout.rows} * var(--dashboard-param-grid-row-size, 2.35rem))`
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card dashboard-param-matrix-cell", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "dashboard-param-list dashboard-param-list--grid", style: listStyle, children: Object.entries(block).map(([name, spec]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "dashboard-param-row", children: [
