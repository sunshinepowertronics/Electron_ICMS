...
function Logs() {
  ...
  const [rxAsciiLines, setRxAsciiLines] = reactExports.useState([]);
  ...
  const handleGetLogs = async () => {
    ...
    try {
      ...
      unsubscribeRef.current = window.icms.onSerialRawData(({ hex }) => {
        ...
        setRxAsciiLines((prev) => [...prev, ascii || hex.toUpperCase()]);
      });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "page-title", children: "Logs" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "serial-readout", "aria-label": "Logs response", style: { marginTop: "1rem" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "serial-readout-bar", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "serial-readout-summary", children: error ? /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: error }) : txHex ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: "Request sent · listening for response…" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: "Ready." }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "serial-readout-log", role: "log", "aria-live": "polite", children: [
        ...
        rxAsciiLines.length > 0 ? rxAsciiLines.map((line, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "serial-readout-line", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { opacity: 0.75 }, children: "[RX ASCII]" }),
          " ",
          line
        ] }, `${idx}-${line}`)) : txHex && !busy && !error ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "serial-readout-placeholder", children: "No valid logs response frame received." }) : null
      ] })
    ] })
  ] });
}
