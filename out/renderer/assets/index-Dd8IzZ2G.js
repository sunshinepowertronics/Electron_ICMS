...
const LEFT_COLUMN = ["cooling_params", "power_params"];
const RIGHT_COLUMN = ["alarm_params", "version_params"];
...
function getMonitorParamGroups(modelName, firmwareVersion) {
...
function ParamSectionCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card dashboard-param-matrix-cell", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "dashboard-param-list", children: Object.entries(block).map(([name, spec]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "dashboard-param-row", children: [
...
function Dashboard() {
  ...
  const groups = getMonitorParamGroups(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dashboard-param-matrix", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dashboard-param-column", children: LEFT_COLUMN.map((groupKey) => {
        const block = groups[groupKey];
        if (!block || Object.keys(block).length === 0) return null;
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ParamSectionCard, { groupKey, block }, groupKey);
      }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dashboard-param-column", children: RIGHT_COLUMN.map((groupKey) => {
        const block = groups[groupKey];
        if (!block || Object.keys(block).length === 0) return null;
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ParamSectionCard, { groupKey, block }, groupKey);
      }) })
