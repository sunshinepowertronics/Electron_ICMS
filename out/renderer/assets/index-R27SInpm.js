...
function scalarFromSpec(spec, words, coils, alarmDiscreteTriple) {
  if (spec.length < 4) return null;
  const modeToken = spec.length > 4 ? String(spec[4]).toLowerCase().trim() : "";
  const mode = modeToken === "int16" || modeToken === "float" || modeToken === "bit" ? modeToken : !modeToken && coils && !words ? "bit" : "";
...
async function writeSettingsAsciiRegisters(slaveId, spec, text) {
  ...
  for (let i = 0; i < chars.length; i++) {
    const code = chars[i].charCodeAt(0) & 65535;
...
const GROUP_SECTION_LABEL = {
  cooling_params: "Cooling",
  alarm_params: "Alarms",
  version_params: "Device information"
};
function SettingsParamEditDialog({
  ...
  const describedBy = reactExports.useMemo(() => {
    const ids = [];
    if (rangeLabel || ascii) ids.push(descId);
    return ids.length ? ids.join(" ") : void 0;
  }, [rangeLabel, ascii, descId]);
  ...
  const runWrite = async () => {
    ...
    try {
      ...
      if (ascii) {
        const res2 = await writeSettingsAsciiRegisters(slaveId, spec, textInput);
        if (!res2.ok) {
          setError(res2.error);
          return;
        }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "settings-edit-modal-backdrop",
      role: "presentation",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "settings-edit-modal-header", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "settings-edit-modal-eyebrow", children: "Edit parameter" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { id: titleId, className: "settings-edit-modal-title", children: paramName }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "settings-edit-modal-section", children: GROUP_SECTION_LABEL[groupKey] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-edit-modal-body", children: [
              (rangeLabel || ascii) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: descId, className: "settings-edit-modal-meta", children: [
                rangeLabel ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-edit-meta-row", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "settings-edit-meta-label", children: "Allowed range" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "settings-edit-meta-value", children: rangeLabel })
                ] }) : null,
                ascii ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "settings-edit-hint", children: "ASCII encoding: one character is written per holding register." }) : null
              ] }),
              isAlarm ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-edit-alarm-card", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-edit-alarm-card-head", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "settings-edit-alarm-card-title", children: "Alarm state" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: `settings-edit-status-pill ${toggleOn ? "settings-edit-status-pill--on" : "settings-edit-status-pill--off"}`,
                      children: toggleOn ? "Enabled" : "Disabled"
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "settings-edit-alarm-card-desc", children: "Choose whether this alarm is enabled on the device. The change is sent when you save." }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-edit-toggle-row", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "settings-edit-toggle-caption", children: "Off / on" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      className: `settings-edit-toggle ${toggleOn ? "settings-edit-toggle--on" : "settings-edit-toggle--off"}`,
                      onClick: () => setToggleOn(!toggleOn),
                      disabled: busy,
                      "aria-pressed": toggleOn,
                      "aria-label": toggleOn ? "Alarm is enabled. Press to disable." : "Alarm is disabled. Press to enable.",
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "settings-edit-toggle-knob" })
                    }
                  )
                ] })
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "settings-edit-field", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "settings-edit-field-label", children: inputLabel }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
              ...
              error ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-edit-alert", role: "alert", children: error }) : null
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "settings-edit-modal-footer", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  className: "settings-edit-btn settings-edit-btn--secondary",
                  onClick: onClose,
                  disabled: busy,
                  children: "Cancel"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "settings-edit-btn settings-edit-btn--primary", onClick: runWrite, disabled: busy, children: busy ? "Saving…" : "Save changes" })
            ] })
          ]
        }
      )
