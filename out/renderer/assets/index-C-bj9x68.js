...
async function writeSettingsAlarmBool(slaveId, query, spec, on) {
  ...
  if (query === "query2") {
    ...
    return window.icms.writeSerialBytes([...f2]);
  }
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            rangeLabel ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "settings-edit-modal-range", children: [
              "Range: (",
              rangeLabel,
              ")"
            ] }) : null,
            ascii ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "settings-edit-modal-hint", children: "ASCII — one character per register" }) : null,
            isAlarm ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-edit-toggle-block", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: `settings-edit-toggle-label ${toggleOn ? "settings-edit-toggle-label--on" : "settings-edit-toggle-label--off"}`,
            ...
            error ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "settings-edit-error", children: error }) : null,
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-edit-actions", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "settings-edit-btn settings-edit-btn--ghost", onClick: onClose, disabled: busy, children: "Cancel" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "settings-edit-btn settings-edit-btn--primary", onClick: runWrite, disabled: busy, children: busy ? "…" : isAlarm ? "OK" : "Submit" })
            ] })
          ]
        }
      )
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              ParamSectionCard,
              {
                ...
                liveByParamName,
                interactive: true,
                onParamRowClick: (p) => setEditTarget({ groupKey, ...p })
              }
            )
          },
          groupKey
