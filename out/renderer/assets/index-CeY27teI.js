...
function resolveSettingsEntry(modelName, firmwareVersion) {
  ...
  const versionEntry = product.versions.find((v) => v.version === fw);
  if (!versionEntry?.sidebar_params) return null;
  const settings = versionEntry.sidebar_params.find(
...
function ParamSectionCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card dashboard-param-matrix-cell", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dashboard-param-section-cols", children: columnChunks.map((colEntries, colIndex) => /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "dashboard-param-list dashboard-param-col", children: colEntries.map(([name, spec]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "dashboard-param-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dashboard-param-name", children: name }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dashboard-param-default", children: formatDefault(spec.length > 1 ? spec[1] : void 0) }),
...
function Settings() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "page-title", children: "Settings" }),
    !groups ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "settings-app-note", children: [
        "Platform: ",
        platform,
        "."
      ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-layout", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-main", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "content-toolbar", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "content-toolbar-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
