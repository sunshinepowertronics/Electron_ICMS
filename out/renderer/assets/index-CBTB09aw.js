...
function DisplayViewProvider({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DisplayViewContext.Provider, { value: { view, serialConnected, serialLineCount }, children });
}
...
function MonitorTrafficOverview() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "page-title", children: "Traffic" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        ...
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "View → Display Options → Show Data" }),
        " for the standard monitor summary."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: serialConnected ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Connected." }),
        " ",
        serialLineCount,
        " line",
        serialLineCount === 1 ? "" : "s",
        " in the rolling buffer (up to 500)."
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Not connected." }),
        " Use the toolbar Connect button to open a port and capture traffic."
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Using this log" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "Cross-check bytes with your device’s Modbus map or protocol guide. Errors from the port appear in the log with an ",
...
const DASHBOARD_PARAM_GROUPS = {
  cooling_params: {
    "Temp(Cab)": ["°C", "N/A", "0", "0.01"],
    "Temp(Amb)": ["°C", "N/A", "1", "0.01"],
    Δt: ["°C", "N/A", "2", "0.1", "int16"],
    "PWM Duty": ["%", "N/A", "3", "1"],
    "Fan 1 Run Hour": ["hr", "N/A", "5", "1"],
    "Fan 2 Run Hour": ["hr", "N/A", "6", "1"]
  },
  power_params: {
    "System Voltage": ["V", "N/A", "4", "0.1"]
  },
  alarm_params: {
    Smoke: ["", "N/A", "0", "1", "bit"],
    Door: ["", "N/A", "1", "1", "bit"],
    HCT: ["", "N/A", "2", "1", "bit"],
    "Usys Low": ["", "N/A", "8", "1", "bit"],
    "T1 Sensor": ["", "N/A", "9", "1", "bit"],
    "T2 Sensor": ["", "N/A", "10", "1", "bit"],
    "Fan On": ["", "N/A", "11", "1", "bit", "fan_status"],
    "Fan 1 Status": ["", "N/A", "4", "1", "bit"],
    "Fan 2 Status": ["", "N/A", "5", "1", "bit"]
  },
  version_params: {
    "FTU HW Model No": ["", "N/A", "9", "0.1"],
    "FTU SW Version": ["", "N/A", "10", "0.001"]
  }
};
const DASHBOARD_PARAM_COLUMNS = [
  ["cooling_params", "power_params"],
  ["alarm_params", "version_params"]
];
...
function Dashboard() {
  ...
  if (view === "traffic") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(MonitorTrafficOverview, {});
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dashboard-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "dashboard-page-title", children: "Dashboard" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dashboard-param-matrix", children: DASHBOARD_PARAM_COLUMNS.map((keys) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dashboard-param-column", children: keys.map((groupKey) => /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "dashboard-param-panel", "aria-labelledby": `dash-section-${groupKey}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "dashboard-param-heading", id: `dash-section-${groupKey}`, children: PARAM_SECTION_TITLES[groupKey] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "dashboard-param-list", children: Object.entries(DASHBOARD_PARAM_GROUPS[groupKey]).map(([name, spec]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "dashboard-param-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dashboard-param-name", children: name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dashboard-param-unit", children: formatUnit(spec[0] ?? "") })
      ] }, name)) })
    ] }, groupKey)) }, `${keys[0]}-${keys[1]}`)) })
  ] });
}
function SettingsTrafficOverview() {
  const { serialConnected, serialLineCount } = useDisplayView();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Traffic mode" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "You are in traffic view. The monitor strip shows RX-tagged hex lines; the buffer keeps up to 500 lines. Use ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "View → Display Options → Show Data" }),
        " for the standard settings and dashboard layout."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "Platform: ",
        platform,
        ".",
        " ",
        serialConnected ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          "Serial is ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "connected" }),
          " (",
          serialLineCount,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Capture" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
...
function Settings() {
  const { view } = useDisplayView();
  if (view === "traffic") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsTrafficOverview, {});
  }
  const platform = typeof window !== "undefined" && window.icms?.platform ? window.icms.platform : "unknown";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "page-title", children: "Settings" }),
    ...
    versions: [
      ...
      },
      {
        ...
        sidebar_params: [
          {
            option_name: "Monitor",
            query1: "slave_id 04 00 00 00 18 F0 00",
          ...
          {
            option_name: "Settings",
            query1: "slave_id 03 00 00 00 18 45 C0",
            query_mapping: {
              cooling_params: "query1",
              alarm_params: "query1",
              version_params: "query1"
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "serial-readout traffic-view", "aria-label": "Serial traffic", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "serial-readout-log", role: "log", "aria-live": "polite", children: !connected ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "serial-readout-placeholder", children: "Use the toolbar Connect button to open a port and view traffic." }) : lines.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "serial-readout-placeholder", children: "No frames yet — waiting for bytes on the wire…" }) : lines.map((row) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "serial-readout-line traffic-view-line", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "traffic-view-tag", "aria-hidden": "true", children: "RX" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "traffic-view-payload", children: text })
      ] }, key);
    }) })
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-layout", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-main", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "content-toolbar", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "content-toolbar-spacer", "aria-hidden": "true" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
      ...
      displayView === "data" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "serial-readout", "aria-label": "Serial connection", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "serial-readout-bar", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: serialSession ? "serial-readout-dot" : "serial-readout-dot serial-readout-dot--idle",
              "aria-hidden": "true"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "serial-readout-summary", children: serialSession ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            "Port ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: serialSession.path }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "serial-readout-sep", "aria-hidden": "true" }),
            serialSession.baudRate,
            " baud",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "serial-readout-sep", "aria-hidden": "true" }),
            "Slave ID ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: serialSession.slaveId || "—" })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            "Data — ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Not connected" })
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "serial-readout-log", role: "log", "aria-live": "polite", children: !serialSession ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "serial-readout-placeholder", children: "Use the toolbar Connect button to open a port and view raw data." }) : serialLines.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "serial-readout-placeholder", children: "Reading port — waiting for incoming bytes…" }) : serialLines.map((row) => {
          const tab = row.indexOf("	");
          const key = tab >= 0 ? row.slice(0, tab) : row;
          const text = tab >= 0 ? row.slice(tab + 1) : row;
          return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "serial-readout-line", children: text }, key);
        }) })
      ] }) : null,
      displayView === "traffic" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        Traffic,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        DisplayViewProvider,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "content", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
        }
      )
    ] })
  ] });
