...
async function writeSettingsAsciiRegisters(slaveId, spec, text, onProgress) {
  ...
  onProgress?.({ written: 0, total: numRegs });
  for (let r = 0; r < numRegs; r++) {
    ...
    onProgress?.({ written: r + 1, total: numRegs });
  }
  return { ok: true };
}
...
function SettingsParamEditDialog({
  ...
  const runWrite = async () => {
    ...
    try {
      ...
      if (ascii) {
        setWriteProgress({ written: 0, total: asciiTotalRegs });
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            busy && ascii && writeProgress && writeProgress.total > 1 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-edit-progress", role: "status", "aria-live": "polite", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-edit-progress-track", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    width: `${Math.min(
                      100,
                      Math.max(0, Math.round(writeProgress.written / Math.max(1, writeProgress.total) * 100))
                    )}%`
                  }
                }
              ) })
