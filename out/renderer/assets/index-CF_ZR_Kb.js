...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Inventory and Customer Management System. Use the sidebar to open Inventory, Customers, Orders, or Settings." })
    ] }),
    PARAM_SECTION_ORDER.map((groupKey) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card", children: [
